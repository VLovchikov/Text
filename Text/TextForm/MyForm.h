...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label6->Text = L"Текущий текст:";
			// 
			// label7
			// 
			...
			this->label7->Text = L"Редактирование:";
			// 
			// TTextBox2
			// 
